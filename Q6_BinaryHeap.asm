...
# $a0: current number of elements in the binary min heap
# $a1: starting memory address of the binary min heap
# $a2: new 32-bit signed integer to push into the binary min heap
min_heap_push:
################################################################################
# FIXME
  move  $t0, $a0
